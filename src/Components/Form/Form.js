...
//   }
  ...
  addToInventory = () => {
    ...
    // }
    axios
      .post("api/product", { name, price, img_url })
      .then((res) => {
        this.setState({
          name: res.data.name,
        ...
        <div>
          {img_url ? (
            ...
            <img
              className="form-image"
              alt="form-product-preview"
              src="https://wantedbazaar.com/wp-content/themes/Wanted-Bazaar/images/nothumb/nothumb370x300.png"
            />
          )}
        </div>
